...
describe('routes', () => {
  ...
  describe('GET /api/me', () => {
    it('returns current user', async () => {
      ...
      expect(json).toEqual({ name: '我', avatarFileId: null, avatarUrl: null, favorites: [], repostedPostIds: [] })
    })
  })
  ...
  describe('PATCH /api/me', () => {
    it('updates user name', async () => {
      ...
      expect(res.status).toBe(200)
      expect(await res.json()).toEqual({ name: '小明', avatarFileId: null, avatarUrl: null, favorites: [], repostedPostIds: [] })
    })
